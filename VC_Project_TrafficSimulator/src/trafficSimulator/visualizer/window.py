...
class Window:
    ...
    def draw_segments(self):
        for segment in self.simulation.segments:
            dpg.draw_polyline(segment.points, color=segment.color(), thickness=3.5*self.zoom, parent="Canvas")
            dpg.draw_arrow(segment.points[-1], segment.points[-2], thickness=0, size=2, color=(0, 0, 0, 255), parent="Canvas")
